...
# effects wrong here, only gives regression parameters
...
# using lm rather than glm, check any difference
...
round(predict(m5, data.frame(percentage.black = (seq(10, 80, 10))), 
              interval = "confidence", level = 0.9), 3)
