...
```{r}
#| code-summary: "Output from broom.mixed"
...
```{r}
#| warning: false
modelsummary(m1, gof_map = NA, statistic = 'conf.int', conf_level = 0.95, shape = term ~ model + statistic)
```
...
```{r class.output = "numberLines lineAnchors"}
#| code-summary: "Code 3.5 model 1 summary"
#| code-block-bg: true
#| highlight-style: github
#| source-line-numbers: "1"
#| class-output: "highlight numberLines"
